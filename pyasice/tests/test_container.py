...
def test_bdoc_data_files(temporary_file):
    ...
    bdoc_file = XAdES.open(temporary_file)
...
def test_bdoc_prepare_signature(certificate_rsa_bytes, cert_type):
    ...
    with pytest.raises(XAdES.NoFilesToSign):
